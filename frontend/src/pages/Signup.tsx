    ...
    <div className="min-h-screen bg-quantis-bg flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-quantis-text">Create your account</h1>
          <p className="text-quantis-text-muted mt-2">Start building intelligent portfolios</p>
        </div>
        ...
        <div className="card p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-quantis-text-muted" />
                <input
                  type="text"
                  value={name}
          ...
          <div className="mt-6 text-center">
            <p className="text-quantis-text-muted text-sm">
              ...
              <Link to="/login" className="text-quantis-accent hover:underline">
                Sign in
              </Link>
            </p>
          </div>
